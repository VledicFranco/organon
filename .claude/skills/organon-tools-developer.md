...
1. **Read `organon-tools/ETHOS.md`** - 6 invariants, 5 principles, 8 heuristics
2. **Read `organon-tools/PHILOSOPHY.md`** - 5 design decisions and trade-offs
...
From `organon-tools/PHILOSOPHY.md`:
...
1. **RFC pattern** (from `book-llms/patterns.md`):
   ...
   - [ ] Update implementation (`organon-tools/src/core/frontmatter-parser.ts`)
   - [ ] Update tests
