...
import io.github.vledicfranco.organon.testing.{Convention, NamingConventionAssertionError, NamingConventionViolation}
import io.github.vledicfranco.organon.testing.core.resolvers.ExtractedString
